...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/07/18 12:08:39 by tkwak             #+#    #+#             */
/*   Updated: 2024/07/18 12:08:41 by tkwak            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
*/
ClapTrap::ClapTrap(void) : m_name("default"), m_hit_points(10), m_energy_points(10), m_attack_damage(0)
{
...
{
    std::cout << "Constructor " << Y << "[" << name << "]" << EOC << std::endl;
    this->m_name = name;
...
void ClapTrap::attack(const std::string& targetObject)
{
    ...
    std::cout << "ClapTrap " << this->m_name << R \
...
void ClapTrap::takeDamage(unsigned int damagePoints)
{
    ...
    std::cout << "ClapTrap " << this->m_name << R << " takes damage" << EOC \
...
void ClapTrap::beRepaired(unsigned int repairPoints)
{
    ...
    this->m_energy_points--;
    std::cout << "ClapTrap " << this->m_name << " is " << G \
